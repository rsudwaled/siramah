<div class="row p-1">
    ...
    <div class="col-md-5">
        <x-adminlte-card title="Antrian Hari Ini" class="mr-2" theme="success">
            <div class="row">
                <div class="col-md-3">
        ...
        <x-adminlte-card body-class="p-1" class="mr-2">
            <video width="100%" height="100%" controls autoplay muted loop>
                <source src="{{ asset('bpjs/0.mp4') }}" type="video/mp4">
                ...
                <div class="carousel-inner">
                    @foreach ($jadwals->chunk(15) as $chunkKey => $chunk)
                        <div class="carousel-item {{ $chunkKey == 0 ? 'active' : '' }}">
                            <x-adminlte-card title="Jadwal Dokter Hari Ini" theme="success">
