        ...
        <div class="col-md-6">
            <x-adminlte-card title="Pendafataran Pasien Lama BPJS" class="m-2" theme="primary">
                <div>
                    ...
                    @endif
                    <x-adminlte-input wire:model='nik' name="nomor" placeholder="Masukan NIK Pasien" igroup-size="lg">
                        <x-slot name="appendSlot">
                            <x-adminlte-button wire:click='cariPasien' theme="primary" label="Cari Pasien" />
                        </x-slot>
                        ...
                        <table class="table table-bordered table-sm">
                            ...
                            @foreach ($suratkontrols as $item)
                                <tr>
                                    ...
                                    <th>
                                        <x-adminlte-button wire:click="pilihSurat('{{ $item->noSuratKontrol }}', '3')"
                                            label="Pilih" class="btn-sm" theme="success" />
                                    </th>
                                </tr>
                            @endforeach
