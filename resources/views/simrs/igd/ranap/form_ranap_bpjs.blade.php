                                        ...
                                        <div class="col-lg-12">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <x-adminlte-input name="no_sep" label="NO.SEP"
                                                            placeholder="masukan No SEP" enable-old-support>
                                                            <x-slot name="prependSlot">
                                                                <div class="input-group-text text-olive">NO SEP</div>
                                                            </x-slot>
                                                            <x-slot name="bottomSlot"><small
                                                                    style="color: rgb(236, 131, 152)"><b>*masukan sep manual
                                                                        yang didapatkan dari vclaim</b></small></x-slot>
                                                        </x-adminlte-input>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <x-adminlte-select name="kelas_pasien" id="r_kelas_id"
                                                            label="Kelas">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <x-adminlte-select name="ruangan_bykelas" id="ruangan_bykelas"
                                                            label="Ruangan">
                                                        </x-adminlte-select>
                                                    </div>
                                            ...
                                            <x-adminlte-card title="kamar pasien berada di :" theme="lightblue"
                                                theme-mode="outline" icon="fas fa-bed"
                                                header-class="text-uppercase rounded-bottom border-info">
                                                apabila terdapat kesalah dalam memilih kamar pasien, silahkan hapus data
                                                kamar pasien terpilih dengan klik tombol berikut : <x-adminlte-button
                                                    label="hapus kamar" theme="danger" class="btn btn-xs"
                                                    icon="fas fa-ban" />
                                            </x-adminlte-card>
                                        </div>
                                    </div>
