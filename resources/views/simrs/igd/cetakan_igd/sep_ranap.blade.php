...
<div class="scaled-content">
    ...
    <table style="font-size: 12px; margin-top:50px; width:100%;">
        ...
        <tr>
            ...
            <td style="width:40%;">
                <table cellspacing="0" cellpadding="5" style="width:80%">
                    <tr>
                        <td>Peserta</td>
                        <td>:</td>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            -{{$data->tujuanKunj->nama??'-'}} <br>
                            -{{$data->flagProcedure->nama??'-'}} <br>
                        </td>
                    </tr>
                    <tr>
                        <td>Poli Perujuk</td>
        ...
        <tr>
            ...
            <td style="width:40%;">
                <table style="font-size: 12px; width:100%;">
                    ...
                    <tr>
                        <td colspan="2" style="text-align: center; padding-top:100px; font-size: 8px;">Waktu:
                            {{ Carbon::now() }} WIB <br>
                            <span style="color: rgb(246, 243, 243)">{{ $user }}
                        </td>
                    </tr>
                </table>
            </td>
    ...
    @else
    <table style="font-size: 12px; margin-top:50px; width:100%; border:1px solid black;">
        <tr>
            <td colspan="2" style="padding-left:50px; text-align:center;">
                <h1>Tidak ada data SEP!</h1>
            </td>
        </tr>
    </table>
@endif
