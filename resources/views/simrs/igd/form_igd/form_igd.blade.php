        ...
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    @else
                    <div class="card {{$res->response->peserta->statusPeserta->kode == 0 ? 'card-success' : 'card-danger'}} card-outline">
                        <div class="card-body box-profile">
                            <div class="card-header">
                                <b>
                                    <p>
                                ...
                                <button type="button" class="btn btn-block {{$res->response->peserta->statusPeserta->kode == 0 ? 'bg-gradient-success' : 'bg-gradient-danger'}} btn-sm mb-2">BPJS :
