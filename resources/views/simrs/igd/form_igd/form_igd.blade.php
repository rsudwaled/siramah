                            ...
                            <div class="row">
                                    ...
                                    <x-adminlte-datatable id="table" class="text-xs" :heads="$heads" :config="$config"
                                        ...
                                        @foreach ($kunjungan as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->status_kunjungan == 2 ? 'kunjungan ditutup' : ($item->status_kunjungan == 1 ? 'kunjungan dibuka' : 'kunjungan dibatalkan') }}
                                                </td>
                                            </tr>
                                        @endforeach
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <button type="button" class="btn btn-block bg-gradient-warning btn-sm mb-2"
                                        ...
                                        kunjungan</button>
                                    <button type="button"
                                        class="btn btn-block bg-gradient-success btn-sm mb-2">Selengkapnya...</button>
            ...
            <div class="row">
                ...
                @else
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-header">
                                <button type="button" class="btn btn-block bg-gradient-success btn-sm mb-2"
                                    data-toggle="modal" data-target="#modalSEPCreate">BUAT SEP</button>
                                <x-adminlte-modal id="modalSEPCreate" title="Buat SEP RM {{ $pasien->no_rm }}"
                                    size="lg" theme="success" v-centered static-backdrop>
                                    <form action="" method="post">
                                        @csrf
                                        <div class="modal-body">
                                            <div class="col-lg-12">
                                                <x-adminlte-callout theme="info" title="Information"><b>Status Pasien :
                                                        {{ $status_pendaftaran == 0 ? 'IGD' : '' }}</b></x-adminlte-callout>
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="card card-primary card-outline">
                                                            <div class="card-body box-profile">
                                                                <h3 class="profile-username text-center">
                                                                    {{ $pasien->nama_px }}</h3>
                                                                <p class="text-muted text-center">RM :
                                                                    {{ $pasien->no_rm }}</p>
                                                                <ul class="list-group list-group-unbordered mb-3">
                                                                    <li class="list-group-item"><b>Je nis Kelamin :
                                                                            {{ $pasien->jenis_kelamin == 'L' ? 'Laki-Laki' : 'Perempuan' }}</b>
                                                                    </li>
                                                                    <li class="list-group-item"><b>Alamat :
                                                                            {{ $pasien->alamat }}</b></li>
                                                                    <li class="list-group-item"><b>NIK :
                                                                            {{ $pasien->nik_bpjs }}</b></li>
                                                                    <li class="list-group-item"><b>BPJS :
                                                                            {{ $pasien->no_Bpjs == null ? 'tidak punya bpjs' : $pasien->no_Bpjs }}</b>
                                                                    </li>
                                                                    <li class="list-group-item"><b>Telp :
                                                                            {{ $pasien->no_telp == null ? $pasien->no_hp : $pasien->no_telp }}</b>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                        <x-adminlte-input name="sep_nama_pasien" type="hidden"
                                                            value="{{ $pasien->nama_px }}" disabled
                                                            fgroup-class="col-md-12" disable-feedback />
                                                        <x-adminlte-input name="no_rm" value="{{ $pasien->no_rm }}"
                                                            type="hidden" disabled fgroup-class="col-md-12"
                                                            disable-feedback />
                                                    </div>
                                                    <div class="col-lg-8">
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                @php $config = ['format' => 'DD-MM-YYYY']; @endphp
                                                                <x-adminlte-input-date name="tgl_sep"
                                                                    value="{{ \Carbon\Carbon::parse(now())->format('Y-m-d') }}"
                                                                    fgroup-class="col-md-12" label="Tanggal SEP"
                                                                    :config="$config" />
                                                                <x-adminlte-input name="ppk_asal" value="RSUD WALED"
                                                                    label="PPK Asal Rujukan" disabled
                                                                    fgroup-class="col-md-12" disable-feedback />
                                                                <x-adminlte-input name="kontak"
                                                                    value="{{ $pasien->no_telp == null ? $pasien->no_hp : $pasien->no_telp }}"
                                                                    label="Kontak" fgroup-class="col-md-12"
                                                                    disable-feedback />
                                                                <x-adminlte-input name="spesialis" value="UGD"
                                                                    label="Spesialis /Sub Spesialis" disabled
                                                                    fgroup-class="col-md-12" disable-feedback />
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <x-adminlte-select2 name="paramedis" required
                                                                    id="paramedis" label="DPJP">
                                                                    <option value="">--pilih dpjp--</option>
                                                                    @foreach ($paramedis as $u)
                                                                        <option value="{{ $u->kode_paramedis }}">
                                                                            {{ $u->nama_paramedis }}</option>
                                                                    @endforeach
                                                                </x-adminlte-select2>
                                                                <x-adminlte-select2 name="alasan_masuk" required
                                                                    id="alasan_masuk" label="Alasan Masuk">
                                                                    <option value="">--pilih alasan masuk--</option>
                                                                    @foreach ($alasanmasuk as $u)
                                                                        <option value="{{ $u->id }}">
                                                                            {{ $u->alasan_masuk }}</option>
                                                                    @endforeach
                                                                </x-adminlte-select2>
                                                                <x-adminlte-select2 name="status_kecelakaan"
                                                                    id="status_kecelakaan" label="Status Kecelakaan">
                                                                    <option value="">--pilih status kecelakaan--
                                                                    </option>
                                                                    <option value="0">Bukan Kecelakaan Lalu Lintas
                                                                        (BKLL)</option>
                                                                    <option value="1">KLL & Bukan Kecelakaan Kerja
                                                                        (BKK)</option>
                                                                    <option value="2">KLL & KK</option>
                                                                    <option value="3">Kecelakaan Kerja</option>
                                                                </x-adminlte-select2>
                                                                <x-adminlte-textarea name="diagnosa" label="Diagnosa"
                                                                    placeholder="Silahkan masukan diagnosa"
                                                                    fgroup-class="col-md-12" />
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <a class="btn btn-app bg-success" onclick="cariRujukan({{ $pasien->no_rm }})"
                                    data-toggle="modal" data-target="#modalRujukan"><i
                                        class="fas fa-external-link-alt"></i> Rujukan </a>
                                <x-adminlte-modal id="modalRujukan" title="Rujukan dari RM:  {{ $pasien->no_rm }}"
                                    size="xl" theme="success" v-centered static-backdrop>
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <h5>Rawat Jalan</h5>
                                ...
                                <a class="btn btn-app bg-danger" data-toggle="modal" data-target="#modalRiwayaSEP"><i
                                        class="fas fa-clipboard-list"></i> Riwayat SEP </a>
                                <x-adminlte-modal id="modalRiwayaSEP" title="Riwayat SEP dari RM :  {{ $pasien->no_rm }}"
                                    size="xl" theme="success" v-centered static-backdrop>
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-lg-6">
                                ...
                                <a class="btn btn-app bg-warning" data-toggle="modal" data-target="#modalBuatSK"><i
                                        class="fas fa-edit"></i>Buat <code>(SK)</code> </a>
                                <x-adminlte-modal id="modalBuatSK"
                                    title="Buat Surat Kontrol untuk RM : {{ $pasien->no_rm }}" size="md"
                                    theme="success" v-centered static-backdrop>
                                    <form action="" method="post">
                                        @csrf
                                        <div class="modal-body">
                                            <div class="col-lg-12">
                                                <x-adminlte-input name="no_bpjs"
                                                    value="{{ $pasien->no_Bpjs == null ? 'tidak punya bpjs' : $pasien->no_Bpjs }}"
                                                    label="No Kartu" fgroup-class="col-md-12" disable-feedback />
                                                <x-adminlte-select2 name="jenis_surat" required id="jenis_surat"
                                                    label="Poli">
                                                    <option value="">--Jenis Surat--</option>
                                                    <option value="surat_kontrol">Surat Kontrol</option>
                                                    <option value="spri">SPRI</option>
                                                </x-adminlte-select2>
                                                <x-adminlte-select2 name="poli_kontrol" required id="poli_kontrol"
                                                    label="Poli">
                                                ...
                                                @php $config = ['format' => 'DD-MM-YYYY']; @endphp
                                                <x-adminlte-input-date name="tgl_sk"
                                                    value="{{ \Carbon\Carbon::parse(now())->format('Y-m-d') }}"
                                                    fgroup-class="col-md-12" label="Tanggal Kontrol" :config="$config" />
                                                <x-adminlte-select2 name="dokter_kontrol" required id="dokter_kontrol"
                                                    label="Dokter">
                                                    <option value="">--pilih dokter--</option>
                                                    @foreach ($paramedis as $u)
                                                        <option value="{{ $u->kode_paramedis }}">{{ $u->nama_paramedis }}
                                                        </option>
                                                    @endforeach
                                                </x-adminlte-select2>
                                            </div>
                                ...
                                <a class="btn btn-app bg-info" data-toggle="modal" data-target="#modalSK"><i
                                        class="fas fa-search"></i>Cari <code>(SK)</code> </a>
                                <x-adminlte-modal id="modalSK"
                                    title="Cari Surat Kontrol/SPRI dari RM: {{ $pasien->no_rm }}" size="xl"
                                    theme="success" v-centered static-backdrop>
                                    <div class="modal-body">
                                        <div class="col-lg-12">
                                            @php
                                            ...
                                            <x-adminlte-datatable id="table5" class="nowrap text-xs" :heads="$heads"
                                                :config="$config" striped bordered hoverable
                                                compressed></x-adminlte-datatable>
                                        </div>
                                    </div>
                                    <x-slot name="footerSlot">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <p><code>STATUS BPJS : {{ $res->response->peserta->noKartu }}</code></p>
                                <button type="button"
                                    class="btn btn-block bg-gradient-success btn-sm mb-2">{{ $res->response->peserta->statusPeserta->keterangan }}</button>
                                @if ($pasien->no_Bpjs == null && $res->response->peserta->statusPeserta->kode == 0)
                                    <button type="button" class="btn btn-block bg-gradient-primary btn-sm mb-2"
                ...
                <div class="col-md-9">
                    <div class="row">
                        <div class="col-lg-12">
                            <x-adminlte-card theme="purple" size="sm" id="div_rajal" icon="fas fa-info-circle"
                                collapsible title="Form Pendaftaran Pasien RAWAT JALAN">
