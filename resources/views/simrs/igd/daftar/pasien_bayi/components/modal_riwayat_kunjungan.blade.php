  ...
  <x-adminlte-modal id="modalCekKunjungan" title="RIWAYAT KUNJUNGAN PASIEN" theme="success" size='xl' static-backdrop>
      <div class="card">
              ...
              <div class="row">
                  <div class="col-5 col-sm-3">
                      <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist"
                          ...
                          <a class="nav-link  btn btn-block btn-primary btn-flat" id="rawat-inap-tab" data-toggle="pill"
                              href="#rawat-inap" role="tab" aria-controls="rawat-inap" aria-selected="true">Rawat
                              Inap</a>
                          <a class="nav-link  btn btn-block bg-purple btn-flat" id="kebidanan-tab" data-toggle="pill"
                              href="#kebidanan" role="tab" aria-controls="kebidanan" aria-selected="true">Unit Kebidanan</a>
                      </div>
                  </div>
                  <div class="col-7 col-sm-9">
                      <div class="tab-content" id="vert-tabs-tabContent">
                          <div class="tab-pane fade active show" id="rawat-jalan" role="tabpanel"
                              ...
                              <table id="riwayatKunjungan" class="riwayatKunjungan data-table table table-bordered">
                                  <thead>
                                      <tr>
                                          <th>KUNJUNGAN</th>
                                          <th>NO RM</th>
                          ...
                          <div class="tab-pane text-left " id="rawat-inap" role="tabpanel"
                              ...
                              <table id="riwayatRanap" class="riwayatRanap data-table table table-bordered">
                                  <thead>
                                      <tr>
                                          <th>KUNJUNGAN</th>
                                          <th>NO RM</th>
                          ...
                          <div class="tab-pane text-left " id="kebidanan" role="tabpanel"
                              ...
                              <table id="UGDKebidanan" class="UGDKebidanan data-table table table-bordered">
                                  <thead>
                                      <tr>
                                          <th>KUNJUNGAN</th>
                                          <th>NO RM</th>
          ...
          <x-slot name="footerSlot">
              <x-adminlte-button theme="danger" label="Tutup" onclick="clearTables()" data-dismiss="modal" />
          </x-slot>
      </div>
  </x-adminlte-modal>
