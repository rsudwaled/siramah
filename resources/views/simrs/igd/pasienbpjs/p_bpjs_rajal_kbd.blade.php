                    ...
                    <x-adminlte-card theme="success" size="sm" id="div_rajal" icon="fas fa-info-circle" collapsible
                        ...
                        <form action="{{ route('pasien-igdbpjs-store') }}" id="formPendaftaranIGD" method="post">
                            ...
                            <div class="col-lg-12">
                                ...
                                <input type="hidden" name="dpjpLayan" value="{{ $antrian->isTriase->kode_paramedis == null ? '' : $antrian->isTriase->kode_paramedis }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <x-adminlte-input name="dpjpLayanan"
                                            value="{{ $antrian->isTriase->kode_paramedis == null ? '' : $antrian->isTriase->kode_paramedis }}"
                                            disabled label="Dpjp" enable-old-support>
                                            <x-slot name="prependSlot">
                                                <div class="input-group-text text-olive">
                                                    {{ $antrian->isTriase->kode_paramedis == null ? '' : $antrian->isTriase->nama_dokter }}
                                                </div>
                                            </x-slot>
                                        </x-adminlte-input>
