<div class="card card-info mb-1">
    <a class="card-header" data-toggle="collapse" data-parent="#accordion" href="#colAnamnesa">
        ...
        <div class="card-tools">
            <button type="button" onclick="modalResumeRanap()" class="btn btn-tool bg-warning"
            ...
            @else
                <button type="button" class="btn btn-tool bg-danger">
                    <i class="fas fa-check"></i> Belum Resume
                </button>
            @endif
        </div>
    </a>
    <div id="colAnamnesa" class="collapse " role="tabpanel" aria-labelledby="hAnamnesa">
        <div class="card-body">
            ...
            <iframe src="{{ route('print_resume_ranap') }}?kode={{ $kunjungan->kode_kunjungan }}" width="100%"
                height="700px" frameborder="0"></iframe>
        </div>
    </div>
</div>
<x-adminlte-modal id="modalResumeRanap" name="modalResumeRanap" title="Resume Rawat Inap" theme="success"
    ...
    <form action="{{ route('simpan_resume_ranap') }}" name="formResume" id="formResume" method="POST"
        ...
        <div class="row">
            ...
            <x-adminlte-textarea name="catatan_laboratorium" fgroup-class="col-md-6" label="Pemeriksaan Laboratorium"
                rows="3" igroup-size="sm" placeholder="Pemeriksaan Laboratorium">
                {{ $kunjungan->erm_ranap->catatan_laboratorium ?? null }}
            </x-adminlte-textarea>
            <x-adminlte-textarea name="catatan_radiologi" fgroup-class="col-md-6" label="Pemeriksaan Radiologi"
                rows="3" igroup-size="sm" placeholder="Pemeriksaan Radiologi">
                {{ $kunjungan->erm_ranap->catatan_radiologi ?? null }}
            </x-adminlte-textarea>
            <x-adminlte-textarea name="catatan_penunjang" fgroup-class="col-md-6"
            ...
            <x-adminlte-textarea name="hasil_konsultasi" fgroup-class="col-md-6" label="Hasil Konsultasi"
