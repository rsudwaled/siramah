...
<x-adminlte-modal id="modalGroupping" name="modalGroupping" title="Groupping E-Klaim Rawat Inap" theme="success"
...
@push('js')
    <script>
        function btnModalGroupping() {
            $.LoadingOverlay("show");
            $('#modalGroupping').modal('show');
            $.LoadingOverlay("hide");
        }
    </script>
@endpush
