<form action="{{ route('simpan_resume_ranap') }}" name="formResume" id="formResume" method="POST"
    ...
    <div class="row">
        <div class="col-md-6">
            <x-adminlte-textarea name="ringkasan_perawatan" label="Ringkasan Perawatan" rows="3" igroup-size="sm"
                placeholder="Ringkasan Perawatan">
                {{ $kunjungan->erm_ranap->ringkasan_perawatan ?? null }}
            </x-adminlte-textarea>
            <x-adminlte-textarea name="riwayat_penyakit" label="Riwayat Penyakit" rows="3" igroup-size="sm"
                placeholder="Riwayat Penyakit">
                {{ $kunjungan->erm_ranap->riwayat_penyakit ?? null }}
            </x-adminlte-textarea>
            <x-adminlte-textarea name="indikasi_ranap" label="Indikasi Ranap" rows="3" igroup-size="sm"
                placeholder="Indikasi Ranap">
                {{ $kunjungan->erm_ranap->indikasi_ranap ?? null }}
            </x-adminlte-textarea>
        </div>
        <div class="col-md-6">
            <x-adminlte-textarea name="pemeriksaan_fisik" label="Pemeriksaan Fisik" rows="4" igroup-size="sm"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8 input-group input-group-sm">
                            <input class="form-control" name="tensi_darah" id="tensi_darah"
                                value="{{ $kunjungan->erm_ranap->tensi_darah ?? null }}" placeholder="Tekanan Darah">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8 input-group input-group-sm">
                            <input class="form-control" name="denyut_nadi" id="denyut_nadi"
                                value="{{ $kunjungan->erm_ranap->denyut_nadi ?? null }}" placeholder="Denyut Nadi">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8 input-group input-group-sm">
                            <input class="form-control" name="pernapasan" id="pernapasan"
                                value="{{ $kunjungan->erm_ranap->pernapasan ?? null }}" placeholder="Pernapasan">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8 input-group input-group-sm">
                            <input class="form-control" name="berat_badan" id="berat_badan"
                                value="{{ $kunjungan->erm_ranap->berat_badan ?? null }}" placeholder="Berat Bdn Bayi">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8 input-group input-group-sm">
                            <input class="form-control" name="kesadaran" id="kesadaran"
                                value="{{ $kunjungan->erm_ranap->kesadaran ?? null }}" placeholder="Kesadaran">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <x-adminlte-textarea name="catatan_laboratorium" fgroup-class="col-md-3" label="Pemeriksaan Laboratorium"
            rows="3" igroup-size="sm" placeholder="Pemeriksaan Laboratorium">
        ...
        <x-adminlte-textarea name="catatan_penunjang" fgroup-class="col-md-3" label="Pemeriksaan Penunjang Lainnya"
            rows="3" igroup-size="sm" placeholder="Pemeriksaan Penunjang Lainnya">
            {{ $kunjungan->erm_ranap->catatan_penunjang ?? null }}
        </x-adminlte-textarea>
        <x-adminlte-textarea name="hasil_konsultasi" fgroup-class="col-md-3" label="Hasil Konsultasi" rows="3"
        ...
        <div class="col-md-2">
            ...
            <div class="form-group">
                <div class="custom-control custom-radio">
                    <input class="custom-control-input" type="radio" value="Tidak Diambil" id="shktidakx"
            ...
            @else
                ...
                <div id="row">
                    <div class="form-group">
                        <div class="row">
                            <div class="input-group col-md-6">
                                <input type="text" class="form-control form-control-sm" name="diagnosa_sekunder[]"
                                    placeholder="Diagnosa Sekunder">
                            </div>
                            <div class="input-group col-md-6">
                                <select name="icd10_sekunder[]" class="form-control diagSekunderResume">
                                </select>
        ...
        <div class="col-md-6">
            <div class="row">
                ...
                <x-adminlte-input-date name="tanggal_operasi" label="Tgl Operasi"
                    value="{{ $kunjungan->erm_ranap->tanggal_operasi ?? null }}" igroup-size="sm" :config="$config"
                    fgroup-class="col-md-4" />
                @php
                    $config = ['format' => 'HH:mm:ss'];
                @endphp
                <x-adminlte-input-date name="awal_operasi" label="Awal Operasi"
                    value="{{ $kunjungan->erm_ranap->awal_operasi ?? null }}" igroup-size="sm" :config="$config"
                    fgroup-class="col-md-4" />
                <x-adminlte-input-date name="akhir_operasi" label="Akhir Operasi"
                    value="{{ $kunjungan->erm_ranap->akhir_operasi ?? null }}" igroup-size="sm" :config="$config"
                    fgroup-class="col-md-4" />
            </div>
            {{-- tindakan operasi --}}
            @if ($kunjungan->erm_ranap)
            ...
            @else
                ...
                <div id="row">
                    <div class="form-group">
                        <div class="row">
                            <div class="input-group col-md-6">
                                <input type="text" class="form-control form-control-sm" name="tindakan_operasi[]"
                                    placeholder="Tindakan Operasi">
                            </div>
                            <div class="input-group col-md-6">
                                <select name="icd9_operasi[]" class="form-control icd9operasi">
                                ...
                                <div class="input-group-append">
                                    <button type="button" class="btn btn-xs btn-success" onclick="addIcdOperasi()">
                                        <i class="fas fa-plus "></i>
                                    </button>
                                </div>
                            </div>
            ...
            @else
                ...
                <div id="row">
                    <div class="form-group">
                        <div class="row">
                            <div class="input-group col-md-6">
                                <input type="text" class="form-control form-control-sm" name="tindakan_prosedur[]"
                            ...
                            <div class="input-group col-md-6">
                                ...
                                <div class="input-group-append">
                                    <button type="button" class="btn btn-xs btn-success" onclick="addIcdTindakan()">
                                        <i class="fas fa-plus "></i>
                                    </button>
                                </div>
                            </div>
        ...
        <div class="col-md-3">
            ...
            <div class="form-group">
                <div class="custom-control custom-radio">
                    <input class="custom-control-input" type="radio" value="Sembuh / Perbaikan" id="psembuh"
                        name="cara_pulang"
                ...
                <div class="custom-control custom-radio">
                    <input class="custom-control-input" value="Pulang Paksa" type="radio" id="pplngpaksa"
                        name="cara_pulang"
        ...
        <x-adminlte-textarea name="kondisi_umum" label="Keadaan Umum" fgroup-class="col-md-3" rows="5"
            igroup-size="sm" placeholder="Keadaan Umum">
            {{ $kunjungan->erm_ranap->kondisi_umum ?? null }}
        </x-adminlte-textarea>
        <x-adminlte-textarea name="kondisi_pulang" label="Kondisi Pulang" fgroup-class="col-md-3" rows="5"
            igroup-size="sm" placeholder="Kondisi Pulang">
        ...
        <div class="col-md-3">
            ...
            <div class="form-group">
                <div class="custom-control custom-radio">
                    <input class="custom-control-input" type="radio" value="Poliklinik RSUD Waled" id="ppoli"
                ...
                <div class="custom-control custom-radio">
                    <input class="custom-control-input" value="Dokter Praktek" type="radio" id="pdokterpraktek"
                        name="pengobatan_lanjutan"
        ...
        <x-adminlte-textarea name="instruksi_pulang" fgroup-class="col-md-4" label="Instruksi Pulang" rows="5"
        ...
        <x-adminlte-textarea name="kembali_jika" fgroup-class="col-md-4"
            label="Segera kembali ke Rumah Sakit, langsung ke IGD jika terjadi" rows="5" igroup-size="sm"
            placeholder="Segera kembali ke Rumah Sakit, langsung ke IGD jika terjadi">
