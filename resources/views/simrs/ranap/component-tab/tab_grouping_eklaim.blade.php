<div class="tab-pane fade show active" id="tab-grouping-eklaim" role="tabpanel" aria-labelledby="tab-grouping-eklaim-tab">
    <div class="row">
            ...
            <div class="info-box bg-gradient-success">
                ...
                <div class="info-box-content">
                    <dl class="row" style="font-size: 14px">
                        <dt class="col-sm-2 m-0">No SEP</dt>
                        <dd class="col-sm-10 m-0">: {{ $kunjungan->no_sep }}</dd>
                        <dt class="col-sm-2 m-0">Tarif RS</dt>
                        <dd class="col-sm-10 m-0">: Rp. <span class="biaya_rs_html">-</span></dd>
                        <dt class="col-sm-2 m-0">Tarif E-Klaim</dt>
                        <dd class="col-sm-10 m-0">: Rp. <span class="tarif_eklaim_html">-</span></dd>
                        <dt class="col-sm-2 m-0">Groupping</dt>
                        <dd class="col-sm-10 m-0">: <span class="code_cbg_html">-</span></dd>
                    </dl>
                </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <form action="{{ route('claim_ranap_v3') }}" id="formGroupper" method="POST">
                ...
                <div class="row">
                    <button type="submit" form="formGroupper" class="btn btn-sm btn-success text-right" >Simpan Data Grouping</button>
                </div>
            </form>
            {{-- <x-slot name="footerSlot">
                <x-adminlte-button theme="success" class="mr-auto withLoad" label="Groupper" type="submit"
                    icon="fas fa-diagnose"  />
