<div class="tab-pane fade show active" id="tab-soap-perkembangan" role="tabpanel"
    aria-labelledby="tab-soap-perkembangan-tab">
    <div class="row">
        <div class="card-body">
            ...
            <x-adminlte-button id="saveButton" label="Simpan Data-SOAP" icon="fas fa-save" theme="success"
                class="btn-xs" style="display: none;" onclick="btnSavePerkembangan()" />
            <x-adminlte-button id="cancelInputButton" label="Batal Input" icon="fas fa-window-close" theme="danger"
                class="btn-xs" style="display: none;" onclick="batalInput()" />

            <x-adminlte-button icon="fas fa-sync" id="btn-get-observasiranap" theme="primary" class="btn-xs"
                onclick="getObservasiRanap()" />
            <a href="{{ route('print_perkembangan_ranap') }}?kunjungan={{ $kunjungan->kode_kunjungan }}" target="_blank"
                id="btn-print-perkembangan" class="btn btn-xs btn-warning"><i class="fas fa-print"></i> Print</a>
