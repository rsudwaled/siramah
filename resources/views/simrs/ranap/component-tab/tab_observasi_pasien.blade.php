<div class="tab-pane fade" id="tab-observasi-pasien" role="tabpanel" aria-labelledby="tab-observasi-pasien-tab">
    <div class="row">
        <div class="card-body">
            ...
            <button onclick="tambahObservasi()" style="display: none;" class="btn-xs btn btn-success"
                id="btn-saveObservasi" class="btn btn-success mr-auto"><i class="fas fa-save"></i>
                Simpan</button>
