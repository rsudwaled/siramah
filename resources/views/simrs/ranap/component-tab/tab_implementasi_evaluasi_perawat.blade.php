<div class="tab-pane fade" id="tab-implementasi-evaluasi" role="tabpanel" aria-labelledby="tab-implementasi-evaluasi-tab">
    <div class="row">
        <div class="card-body">
            ...
            <x-adminlte-button label="Input Keperawatan" id="btnInputKeperawatan" icon="fas fa-plus" theme="success"
                class="btn-xs" onclick="btnInputKeperawatan()" />
            ...
            <x-adminlte-button id="cancelInputButtonInputKeperawatan" label="Batal Input" icon="fas fa-window-close"
                theme="danger" class="btn-xs" style="display: none;" onclick="batalInputEvaluasiKeperawatan()" />
            <x-adminlte-button icon="fas fa-sync" id="btn-getperkembangan-ranap" theme="primary" class="btn-xs"
                onclick="getKeperawatanRanap()" />
            <a href="{{ route('print_implementasi_evaluasi_keperawatan') }}?kunjungan={{ $kunjungan->kode_kunjungan }}"
                id="btn-print-perkembangan-keperawatan" target="_blank" class="btn btn-xs btn-warning"><i
