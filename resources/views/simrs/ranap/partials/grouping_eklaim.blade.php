<form action="{{ route('claim_ranap_v3') }}" id="formGroupper" method="POST">
    @csrf
    <input type="hidden" name="counter" id="counter" class="counter-id" value="{{ $kunjungan->counter }}">
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <x-adminlte-input name="nomorkartu" class="nomorkartu-id" value="{{ $pasien->no_Bpjs }}" igroup-size="sm"
            ...
            <x-adminlte-input name="nohp" class="nohp-id" label="Nomor HP" igroup-size="sm" placeholder="Nomor HP" />
        ...
        <div class="col-md-4">
            ...
            <x-adminlte-input name="dokter_dpjp" class="dokter-id" label="Dokter DPJP"
                value="{{ $kunjungan->dokter->nama_paramedis }}" igroup-size="sm" placeholder="Dokter DPJP" readonly />
            <x-adminlte-select name="kelas_rawat" class="kelasrawat-id" label="Kelas Rawat" igroup-size="sm">
        ...
        <div class="col-md-4">
            ...
            <x-adminlte-input name="diastole" value="{{ $groupping->diastole ?? null }}" label="Diastole"
