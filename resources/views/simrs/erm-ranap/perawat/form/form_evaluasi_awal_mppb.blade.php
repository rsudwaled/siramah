<form action="#" name="formEvaluasiMPPB" id="formEvaluasiMPPB" method="POST">
    @csrf
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="row">
                <div class="col-md-6">
                    ...
                    @endphp
                    <x-adminlte-input-date name="tgl_pengisian_mppb" id="tgl_pengisian_mppb" label="Tgl Pengisian" fgroup-class="row"
        ...
        <div class="col-lg-12">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title">Form Evaluasi Awal MPP B</h3>
    ...
    <div class="row float-right">
        <button type="submit" class="btn btn-md btn-success" form="formEvaluasiMPPB">
