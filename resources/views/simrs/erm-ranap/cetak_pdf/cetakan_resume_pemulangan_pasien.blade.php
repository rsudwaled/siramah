            ...
            <table class="table table-bordered" style="width: 100%; font-size:11px;">
                <tbody>
                    ...
                    <tr style="border-bottom: 1px solid black;">
                        ...
                        <td style="margin: 0; padding:5px; width:28%;">
                    ...
                    @if ($umur == 0 || $umur < 30 || $kunjungan->kode_unit == '2005')
                        <tr>
                            <td colspan="3"
                                style="margin: 0; padding:5px; height:40px; border-bottom: 1px solid black; border-top: 1px solid black;">
                    ...
                    <tr>
                        <td style="margin: 0; padding:3px; height:auto; border:1px solid black;" colspan="2">
                            <strong style="margin: 0.5rem 0;">Tindakan Operasi</strong>
                        </td>
                        <td style="width:19%; margin: 0; padding:3px; border:1px solid black;">
                            ICD9 CM:
                        </td>
                    </tr>
                    <tr>
        ...
        <div class="page-break content ">
            <table class="table table-bordered" style="width: 100%; font-size:11px;">
                <tbody>
                                ...
                                @if ($riwayatObat->isNotEmpty())
                                    ...
                                    <div style="page-break-inside: avoid;">
                                        @foreach ($chunks as $index => $chunk)
                                            <div
                                                style="height: auto; width: 48%; margin-right: 1%; margin-bottom: 5px; display: inline-block; vertical-align: top; box-sizing: border-box; page-break-inside: avoid;">
                                                <table
                        ...
                        <td colspan="3" style="height: auto; padding: 2px; width: 100%; box-sizing: border-box;">
                            <table
                                ...
                                <tbody>
                                    ...
                                    @else
                                        <tr>
                                            <td style="padding: 3px; boder:1px solid black;">-</td>
                                            <td style="padding: 3px; boder:1px solid black;">-</td>
                                            <td style="padding: 3px; boder:1px solid black;">-</td>
                                            <td style="padding: 3px; boder:1px solid black;">-</td>
                                            <td style="padding: 3px; boder:1px solid black;">-</td>
                    ...
                    <tr>
                        <td colspan="3" style="margin:0px; padding:2px; border:1px solid black;">
                            Cara Keluar:
                            @php
                    ...
                    <tr>
                        <td colspan="3" style="height: auto; padding: 2px; width: 100%; box-sizing: border-box; ">
                            <table
                                ...
                                <tr>
                                    <td style="margin: 0; padding:2px; boder:1px solid black;">Kondisi Pulang:
                                        <br>{{ $resume->kondisi_pulang ?? '' }}
                                    </td>
                                    <td style="margin: 0; padding:2px; boder:1px solid black;">Keadaan Umum:
                                        <br>{{ $resume->keadaan_umum ?? '' }}
                                    </td>
                                    <td style="margin: 0; padding:2px; boder:1px solid black;">Kesadaran:
                                        <br>{{ $resume->kesadaran ?? '' }}
                                    </td>
                                    <td style="margin: 0; padding:2px; boder:1px solid black;">Tekanan Darah:
                                        <br>{{ $resume->tekanan_darah ?? '' }}
                                    </td>
                                    <td style="margin: 0; padding:2px; boder:1px solid black;">Nadi:
                                        <br>{{ $resume->nadi ?? '' }}
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td colspan="3" style="margin: 0;padding:2px; border:1px solid black;">
                    ...
                    <tr>
                        <td colspan="3"
                            style="height: auto; padding: 2px; width: 100%; box-sizing: border-box; border:1px solid black;">
                            <table style="width: 100%;  border-collapse: collapse;">
                                <tr>
                                    <td rowspan="4" style="border:1px solid black;">Instruksi Pulang : <br>
                                        {{ $resume->ket_intruksi_pulang ?? '' }}</td>
                                    <td style="margin: 0; padding:2px; border:1px solid black;">Kontrol Tanggal :
                                        {{ $resume->tgl_kontrol ?? '-' }} || Di :
                                        {{ $resume->lokasi_kontrol }}</td>
                                </tr>
                                <tr>
                                    <td style="margin: 0; padding:2px; border:1px solid black;">Diet :
                                        {{ $resume->diet ?? '' }} </td>
                                </tr>
                                <tr>
                                    <td style="margin: 0; padding:2px; border:1px solid black;">Latihan:
                                        {{ $resume->latihan ?? '' }} </td>
                                </tr>
                                <tr>
                                    <td style="margin: 0; padding:2px; border:1px solid black;">Segera kembali ke Rumah
