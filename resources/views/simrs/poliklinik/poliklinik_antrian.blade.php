    ...
    <div class="row">
        <div class="col-12">
            ...
            @if (isset($antrians))
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <x-adminlte-card theme="secondary" icon="fas fa-info-circle" collapsible="collapsed"
                            title="Total Antrian Pasien Poliklinik ({{ $antrians->count() }} Orang)">
                            @php
                                $heads = ['Kodeboking', 'Kunjungan', 'Pasien', 'Action', 'SEP / Ref'];
                                $config['order'] = ['3', 'asc'];
                                $config['paging'] = false;
                ...
                <x-adminlte-modal id="modalSuratKontrol" name="modalSuratKontrol" title="Buat Surat Kontrol Rawat Jalan"
                    ...
                    {{-- <form action="{{ route('vclaim.buat_surat_kontrol') }}" id="formSuratKontrol" method="post">
                        ...
                        <x-adminlte-input name="nomorsep_suratkontrol" placeholder="Nomor SEP" label="Nomor SEP"
                            readonly />
                        <x-adminlte-input name="namapoli_suratkontrol" placeholder="Nama Poliklinik" label="Poliklinik"
                            readonly />
                        <x-adminlte-input-date name="tanggal_suratkontrol" label="Tanggal Surat Kontrol" :config="$config"
