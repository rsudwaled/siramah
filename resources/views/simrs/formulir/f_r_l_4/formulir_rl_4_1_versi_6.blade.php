...
@section('title', 'Formulir RL 4.1')
@section('content_header')
    <h1>KOMPILASI PENYAKIT/MORBIDITAS PASIEN RAWAT INAP</h1>
@endsection
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="row mt-4 float-right">
                                        ...
                                        @if (isset($data))
                                            <x-adminlte-button type="submit" label="EXPORT DATA" class="bg-purple btn btn-sm m-1"
                                                target="_blank"
                                                onclick="javascript: form.action='{{ route('frl-4-1.export') }}';" />
                                        @endif
                        ...
                        <div class="row invoice-info p-3">
                            <div class="col">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5"><b>: 2025</b></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 table-responsive table-laporan">
                            <table class="table table-sm" style="text-align: center;">
                                <thead>
                                    <tr>
                                    <tr>
                                        <th rowspan="4" style="vertical-align : middle;text-align:center;"id="no">No.
                                            Urut</th>
                                        <th rowspan="4" style="vertical-align : middle;text-align:center;">No. DTD</th>
                                        <th rowspan="4" style="vertical-align : middle;text-align:center;">No. Daftar
                                            terperinci</th>
                                        <th rowspan="4" style="vertical-align : middle;text-align:center;">Golongan Sebab
                                            Penyakit</th>
                                    </tr>
                                    <tr>
                                        <th colspan="18" style="border-top:1px solid #dee2e6;">Jumlah Pasien Hidup dan
                                            Mati menurut Golongan Umur & Jenis Kelamin</th>
                                        <th rowspan="2" colspan="2"
                                            style="vertical-align : middle;text-align:center;">Pasien Keluar (Hidup & Mati)
                                            Menurut Jenis Kelamin</th>
                                        <th rowspan="4" style="vertical-align : middle;text-align:center;"
                                            id="terapi">Jumlah Pasien Keluar Hidup (23+24)</th>
                                        <th rowspan="4" style="vertical-align : middle;text-align:center;"
                                            id="terapi">Jumlah Pasien Keluar Mati</th>
                                    </tr>
                                    <tr>
