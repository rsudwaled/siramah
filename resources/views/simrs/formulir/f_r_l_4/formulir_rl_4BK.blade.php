...
@section('title', 'Formulir RL 4BK')
@section('content_header')
    <h1>MORBIDITAS PASIEN RAWAT JALAN KECELAKAAN</h1>
@endsection

@section('content')
    <div class="row">
        <div class="col-12">
            <x-adminlte-card title="FILTER MORBIDITAS PASIEN RAWAT JALAN KECELAKAAN" theme="secondary" id="hide_div" collapsible>
                    ...
                    <section class="invoice p-3 mb-3">
                        <div class="row p-3 kop-surat" style="vertical-align : middle;text-align:left;">
                            ...
                            <div class="col mt-4">
                                ...
                                <b > DATA KEADAAN MORBIDITAS PASIEN RAWAT JALAN RUMAH SAKIT KECELAKAAN</b>
                            </div>
