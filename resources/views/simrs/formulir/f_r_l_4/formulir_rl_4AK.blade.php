...
@section('title', 'Formulir RL 4AK')
@section('content_header')
    <h1>MORBIDITAS PASIEN RAWAT INAP RUMAH SAKIT KECELAKAAN</h1>
@endsection

@section('content')
    <div class="row">
        <div class="col-12">
            <x-adminlte-card title="FILTER DATA KEADAAN MORBIDITAS PASIEN RAWAT INAP RUMAH SAKIT  KECELAKAAN" theme="secondary" id="hide_div" collapsible>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="row mt-4 float-right">
                                        <x-adminlte-button type="submit" class="withLoad btn btn-sm m-1 bg-primary" label="Lihat Data" />
                                        @if (isset($laporanFM))
                    ...
                    <section class="invoice p-3 mb-3">
                        <div class="row p-3 kop-surat" style="vertical-align : middle;text-align:left;">
                            ...
                            <div class="col mt-4">
                                ...
                                @if (isset($opt))
                                    @if ($opt=='kecelakaan')
                                    <b > DATA KEADAAN MORBIDITAS PASIEN RAWAT INAP RUMAH SAKIT KECELAKAAN</b>
                                    @else
