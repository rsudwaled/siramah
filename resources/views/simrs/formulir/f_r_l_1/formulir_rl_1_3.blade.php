...
@section('title', 'Formulir RL 1.3')
@section('content_header')
    <h1>Formulir RL 1.3</h1>
@endsection

@section('content')
    <div class="row">
        <div class="col-12">
            <x-adminlte-card title="Filter Formulir RL 1.3" theme="secondary" id="hide_div" collapsible>
                ...
                <div id="printMe">
                    <section class="invoice p-3 mb-3">
                        <div class="row p-3 kop-surat">
                            ...
                            <div class="col mt-4">
                                <b >Formulir RL 1.3</b><br>
                                <b >FASILITAS TEMPAT TIDUR RAWAT INAP</b>
                            </div>
                            ...
                            <table class="table table-sm" style="text-align: center;">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2" style="vertical-align : middle;text-align:center;">Jumlah TT</th>
                                        <th colspan="6" style="vertical-align : middle;text-align:center;" id="terapi">Rincian Tempat Tidur Per-Kelas</th>
                                    </tr>
                                    <tr>
                                        <th>VVIP</th>
                                        <th>VIP</th>
