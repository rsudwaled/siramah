...
@section('title', 'Formulir RL 1.2')
@section('content_header')
    <h1>Formulir RL 1.2</h1>
@endsection

@section('content')
    <div class="row">
        <div class="col-12">
            <x-adminlte-card title="Filter Formulir RL 1.2" theme="secondary" id="hide_div" collapsible>
                    ...
                    <section class="invoice p-3 mb-3">
                        <div class="row p-3 kop-surat">
                            ...
                            <div class="col mt-4">
                                ...
                                <b >INDIKATOR PELAYANAN RUMAH SAKIT</b>
                            </div>
                        ...
                        <div class="row invoice-info p-3">
                            <div class="col">
                                <div class="row">
                                    ...
                                    <div class="col-sm-5"><b>: 3.1.0.9.0.1.4</b></div>
                                </div>
                                <div class="row">
                        ...
                        <div class="col-12 table-responsive table-laporan">
                            <div class="col mt-5">
                                <div class="row">
                                    <div class="col-12"><b>RL 1.2 Indikator Pelayanan Rumah Sakit</b></div>
                                </div>
                            </div>
