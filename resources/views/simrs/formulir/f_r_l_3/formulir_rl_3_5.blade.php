...
@section('title', 'Formulir RL 3.5')
@section('content_header')
    <h1>Formulir RL 3.5</h1>
@endsection

@section('content')
    <div class="row">
        <div class="col-12">
            <x-adminlte-card title="Filter Formulir RL 3.5" theme="secondary" id="hide_div" collapsible>
                ...
                <div id="printMe">
                    <section class="invoice p-3 mb-3">
                        <div class="row p-3 kop-surat">
                            ...
                            <div class="col mt-4">
                                <b >Formulir RL 3.5</b><br>
                                <b >KEGIATAN PERINATOLOG</b>
                            </div>
                            ...
                            <table class="table table-sm" >
                                <thead>
                                    <tr>
                                        ...
                                        <th colspan="8" style="text-align: center;">Rujukan</th>
                                        <th colspan="3" style="text-align: center;">Non Rujukan</th>
                                        <th rowspan="3" style="vertical-align : middle;text-align:left;">Dirujuk</th>
                                    </tr>
                                    <tr>
                                        <th colspan="6" style="text-align: center;">Medis</th>
                                        <th colspan="2" style="text-align: center;">Non Medis</th>
                                    </tr>
                                    <tr>
                                        <th>Rumah Sakit</th>
                                        <th>Bidan</th>
