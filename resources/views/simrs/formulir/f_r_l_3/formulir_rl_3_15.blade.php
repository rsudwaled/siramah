...
@section('title', 'Formulir RL 3.15')
@section('content_header')
    <h1>Formulir RL 3.15</h1>
@endsection

@section('content')
    <div class="row">
        <div class="col-12">
            <x-adminlte-card title="Filter Formulir RL 3.15" theme="secondary" id="hide_div" collapsible>
                            ...
                            <table class="table table-sm" style="text-align: center;">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2" style="vertical-align : middle;text-align:center;">Cara Pembayaran</th>
                                        <th colspan="2" colspan="2" style="vertical-align : middle;text-align:center;">Pasien Rawat Inap</th>
                                        <th rowspan="2" style="vertical-align : middle;text-align:center;">Jumlah Pasien Rawat Jalan</th>
                                        <th colspan="3" style="vertical-align : middle;text-align:center;">Jumlah Pasien Rawat Jalan</th>
                                    </tr>
                                    <tr>
