...
@section('title', 'Formulir RL 3.13')
@section('content_header')
    <h1>Formulir RL 3.13</h1>
@endsection

@section('content')
    <div class="row">
        <div class="col-12">
            <x-adminlte-card title="Filter Formulir RL 3.13" theme="secondary" id="hide_div" collapsible>
                ...
                <div id="printMe">
                    <section class="invoice p-3 mb-3">
                        <div class="row p-3 kop-surat">
                            ...
                            <div class="col mt-4">
                                <b >Formulir RL 3.13</b><br>
                                <b >PENGADAAN OBAT, PENULISAN DAN PELAYANAN RESEP</b>
                            </div>
                        ...
                        <div class="col-12 table-responsive table-laporan">
                            <div class="col">
                                <div class="row">
                                    <div class="col-12"><b>3.13. Pengadaan Obat, Penulisan dan Pelayanan Resep</b></div>
                                </div>
                            </div>
                            {{-- Bagian A --}}
                            <div class="col mt-5">
                                <div class="row">
                                    <div class="col-12"><b>A. Pengadaan Obat</b></div>
                                </div>
                            </div>
                            <table class="table table-sm" style="text-align: center;">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Jumlah Item Obat yang tersedia dirumah sakit</th>
                            ...
                            <div class="col mt-5">
                                <div class="row">
                                    <div class="col-12"><b>B. Penulisan dan Pelayanan Resep</b></div>
                                </div>
                            </div>
                            <table class="table table-sm" style="text-align: center;">
                                <thead>
