                            ...
                            <table class="table table-sm" style="text-align: center;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th>{{$kunjunganRD->sum('RUJUKAN')}}</th>
                                        <th>{{$kunjunganRD->sum('NON_RUJUKAN')}}</th>
                                        <th>{{$kunjunganRD->sum('DIRAWAT')}}</th>
                                        <th>{{$kunjunganRD->sum('RUJUK')}}</th>
                                        <th>{{$kunjunganRD->sum('PELAYANAN_PULANG')}}</th>
                                        <th>{{$kunjunganRD->sum('MATI_PRA_PERAWATAN')}}</th>
                                        <th>{{$kunjunganRD->sum('DOA')}}</th>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
