...
@section('title', 'Formulir RL 3.6')
@section('content_header')
    <h1>Formulir RL 3.6</h1>
@endsection

@section('content')
    <div class="row">
        <div class="col-12">
            <x-adminlte-card title="Filter Formulir RL 3.6" theme="secondary" id="hide_div" collapsible>
                ...
                <div id="printMe">
                    <section class="invoice p-3 mb-3">
                        <div class="row p-3 kop-surat">
                            ...
                            <div class="col mt-4">
                                <b >Formulir RL 3.6</b><br>
                                <b >KEGIATAN PEMBEDAHAN</b>
                            </div>
                            ...
                            <table class="table table-sm" style="text-align: center;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th>{{$dataBH->sum('total')}}</th>
                                        <th>{{$dataBH->sum('khusus')}}</th>
                                        <th>{{$dataBH->sum('besar')}}</th>
                                        <th>{{$dataBH->sum('sedang')}}</th>
                                        <th>{{$dataBH->sum('kecil')}}</th>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
