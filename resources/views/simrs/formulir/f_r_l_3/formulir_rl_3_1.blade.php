...
@section('title', 'Formulir RL 3.1')
@section('content_header')
    <h1>Formulir RL 3.1</h1>
@endsection

@section('content')
    <div class="row">
        <div class="col-12">
            <x-adminlte-card title="Filter Formulir RL 3.1" theme="secondary" id="hide_div" collapsible>
