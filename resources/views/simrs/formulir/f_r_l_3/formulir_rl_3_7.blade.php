...
@section('title', 'Formulir RL 3.7')
@section('content_header')
    <h1>Formulir RL 3.7</h1>
@endsection

@section('content')
    <div class="row">
        <div class="col-12">
            <x-adminlte-card title="Filter Formulir RL 3.7" theme="secondary" id="hide_div" collapsible>
                ...
                <div id="printMe">
                    <section class="invoice p-3 mb-3">
                        <div class="row p-3 kop-surat">
                            ...
                            <div class="col mt-4">
                                <b >Formulir RL 3.7</b><br>
                                <b >KEGIATAN RADIOLOGI</b>
                            </div>
