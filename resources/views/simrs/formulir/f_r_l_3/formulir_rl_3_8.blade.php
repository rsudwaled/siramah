...
@section('title', 'Formulir RL 3.8')
@section('content_header')
    <h1>Formulir RL 3.8</h1>
@endsection

@section('content')
    <div class="row">
        <div class="col-12">
            <x-adminlte-card title="Filter Formulir RL 3.8" theme="secondary" id="hide_div" collapsible>
