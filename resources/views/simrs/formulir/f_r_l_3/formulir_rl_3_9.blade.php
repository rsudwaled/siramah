...
@section('title', 'Formulir RL 3.9')
@section('content_header')
    <h1>Formulir RL 3.9</h1>
@endsection

@section('content')
    <div class="row">
        <div class="col-12">
            <x-adminlte-card title="Filter Formulir RL 3.9" theme="secondary" id="hide_div" collapsible>
                ...
                <div id="printMe">
                    <section class="invoice p-3 mb-3">
                        <div class="row p-3 kop-surat">
                            ...
                            <div class="col mt-4">
                                <b >Formulir RL 3.9</b><br>
                                <b >PELAYANAN REHABILITASI MEDIK</b>
                            </div>
