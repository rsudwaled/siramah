...
@section('title', 'Formulir RL 3.14')
@section('content_header')
    <h1>Formulir RL 3.14</h1>
@endsection

@section('content')
    <div class="row">
        <div class="col-12">
            <x-adminlte-card title="Filter Formulir RL 3.14" theme="secondary" id="hide_div" collapsible>
                            ...
                            <table class="table table-sm" style="text-align: center;">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2" style="vertical-align : middle;text-align:center;">Jenis Spesialisasi</th>
                                        <th colspan="6" style="vertical-align : middle;text-align:center;">Rujukan</th>
                                        <th colspan="3" style="vertical-align : middle;text-align:center;">Dirujuk</th>
                                    </tr>
                                    <tr>
