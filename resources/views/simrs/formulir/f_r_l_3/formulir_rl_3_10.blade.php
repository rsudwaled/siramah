...
@section('title', 'Formulir RL 3.10')
@section('content_header')
    <h1>Formulir RL 3.10</h1>
@endsection

@section('content')
    <div class="row">
        <div class="col-12">
            <x-adminlte-card title="Filter Formulir RL 3.10" theme="secondary" id="hide_div" collapsible>
                ...
                <div id="printMe">
                    <section class="invoice p-3 mb-3">
                        <div class="row p-3 kop-surat">
                            ...
                            <div class="col mt-4">
                                <b >Formulir RL 3.10</b><br>
                                <b >KEGIATAN PELAYANAN KHUSUS</b>
                            </div>
                        ...
                        <div class="col-12 table-responsive table-laporan">
                            <table class="table table-sm" style="text-align: center;">
                                ...
                                <tbody>
                                    @foreach ($F310 as $item)
                                        <tr>
                                            <td>{{$loop->iteration}}</td>
                                            <td>{{$loop->NAMATARIF}}</td>
                                            <td>{{$loop->jumlah}}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
