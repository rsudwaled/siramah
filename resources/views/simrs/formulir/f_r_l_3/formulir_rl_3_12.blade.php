...
@section('title', 'Formulir RL 3.12')
@section('content_header')
    <h1>Formulir RL 3.12</h1>
@endsection

@section('content')
    <div class="row">
        <div class="col-12">
            <x-adminlte-card title="Filter Formulir RL 3.12" theme="secondary" id="hide_div" collapsible>
                ...
                <div id="printMe">
                    <section class="invoice p-3 mb-3">
                        <div class="row p-3 kop-surat">
                            ...
                            <div class="col mt-4">
                                <b >Formulir RL 3.12</b><br>
                                <b >KEGIATAN KELUARGA BERENCANA</b>
                            </div>
                            ...
                            <table class="table table-sm" style="text-align: center;">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2" colspan="2">Konseling</th>
                                        <th rowspan="2" colspan="4">KB Baru Dengan Cara Masuk </th>
                                        <th rowspan="2" colspan="3">KB Baru Dengan Kondisi </th>
                                        <th rowspan="2">Kunjungan Ulang</th>
                                        <th rowspan="2" colspan="2">Jumlah Efek Samping</th>
                                    </tr>
                                    <tr>
                                        <th>ANC</th>
                                        <th>Pasca Bersalin</th>
                                        <th>Bukan Rujukan</th>
