                        ...
                        <div class="col-12 table-responsive table-laporan">
                            <table class="table table-sm" style="text-align: center;">
                                <thead>
                                    ...
                                    <tr>
                                        <th colspan="2" style="vertical-align : middle;text-align:center;" id="terapi">Pasien Hidup Menurut Jenis Kelamin</th>
                                        <th colspan="2" style="vertical-align : middle;text-align:center;" id="terapi">Pasien Mati Menurut Jenis Kelamin</th>
                                        <th colspan="2" style="vertical-align : middle;text-align:center;" id="terapi">Total (Hidup & Mati)</th>
                                    </tr>
                                    <tr>
                                        <th></th>
                                        <th></th>
