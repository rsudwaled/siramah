                ...
                <form id="formFilter" action="" method="get">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 row">
                            <x-adminlte-button type="submit" class="withLoad float-right btn btn-sm col-md-4 mr-2" theme="primary"
                                label="Lihat Laporan" />
                                ...
                                onclick="javascript: form.action='{{ route('laporan-rm.kasus-baru.download.hypertensi') }}';" />
                        </div>
                    </div>
                </form>
            </x-adminlte-card>
