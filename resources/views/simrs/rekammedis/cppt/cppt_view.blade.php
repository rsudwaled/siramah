        ...
        <div class="col-lg-6">
            <x-adminlte-card title="Assesmen awal Keperawatan" theme="info" collapsible >
                ...
                <form action=""  method="get">
                    ...
                    <button type="submit" target="_blank"  id="formAnestesi" class="btn btn-success mr-auto">Lihat Data</button>
                </form>
            ...
            <x-adminlte-card title="Assesmen awal Medis" theme="purple"  collapsible>
                ...
                <form method="GET">
                    ...
                    <div class="col-3">
                      ...
                      <button type="submit" target="_blank" id="getDataResume" class="btn btn-success mr-auto">Lihat Data</button>
                    </form>
            </x-adminlte-card>
        </div>
    </div>
...
@section('js')
        ...
        if(id_kunjungan){
            ...
            success:function(res){
                if(res){
                    ...
                    $.each(res,function(key, value){
                        $("#counter").append('<option value="'+value.counter+'">'+'counter: '+value.counter+'</option>');
                    });
                }else{
                $("#counter").empty();
                }
    ...
    $('#getDataResume').click(function() {
        ...
        var url = "{{ route('cppt-rajal-print.get') }}?rm="+rm+"&counter="+counter+"&kode_unit="+kode_unit;
        window.open(url,'_blank');
        return false;
    });
