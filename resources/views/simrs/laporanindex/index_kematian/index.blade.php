...
@section('title', 'Laporan Index Kematian')
@section('content_header')
    <h1>Laporan Index Kematian</h1>
@endsection

@section('content')
    <div class="row">
        <div class="col-12">
            <x-adminlte-card title="Laporan Index Kematian" theme="secondary" id="hide_div" collapsible>
                <form id="formFilter" action="" method="get">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <x-adminlte-input-date name="start" id="from" label="Periode Awal" :config="$config"
                                value="{{ $start == null ? \Carbon\Carbon::parse($request->start)->format('Y-m-d') : $start }}">
                                {{-- value="2023-06-01"> --}}
                        ...
                        <div class="col-md-4">
                            <x-adminlte-input-date name="finish" id="to" label="Periode Akhir" :config="$config"
                                value="{{ $finish == null ? \Carbon\Carbon::parse($request->finish)->format('YYYY-MM-DD') : $finish }}">
                                {{-- value="2023-06-01"> --}}
                                <x-slot name="prependSlot">
                                    <div class="input-group-text bg-primary">
                                        <i class="fas fa-calendar-alt"></i>
                        ...
                        <div class="col-md-4">
                            <x-adminlte-select2 name="kode_paramedis" required id="kode_paramedis" label="Paramedis">
