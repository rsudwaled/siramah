                            ...
                            @foreach ($kunjungans as $kunjungan)
                                ...
                                <td>
                                    <x-adminlte-button class="btn-xs" onclick="btnKunjungan(this)" icon="fas fa-edit"
                                        ...
                                        data-diagutama="{{ $kunjungan->diagnosaicd->diag_utama ?? null }} - {{ $kunjungan->diagnosaicd->diag_utama_desc ?? null }}"
                                        data-diagsekunder1="{{ $kunjungan->diagnosaicd->diag_sekunder_01 ?? null }} - {{ $kunjungan->diagnosaicd->diag_sekunder_01_desc ?? null }}"
                                        data-diagsekunder2="{{ $kunjungan->diagnosaicd->diag_sekunder_02 ?? null }} - {{ $kunjungan->diagnosaicd->diag_sekunder_02_desc ?? null }}"
                                        data-diagsekunder3="{{ $kunjungan->diagnosaicd->diag_sekunder_03 ?? null }} - {{ $kunjungan->diagnosaicd->diag_sekunder_03_desc ?? null }}"
                                        data-diagsekunder4="{{ $kunjungan->diagnosaicd->diag_sekunder_04 ?? null }} - {{ $kunjungan->diagnosaicd->diag_sekunder_04_desc ?? null }}"
                                        data-diagsekunder5="{{ $kunjungan->diagnosaicd->diag_sekunder_05 ?? null }} - {{ $kunjungan->diagnosaicd->diag_sekunder_05_desc ?? null }}"
