    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <x-adminlte-card title="Edit Data Pegawai" theme="success" collapsible>
                <form action="{{ route('data-kepeg.store') }}" id="myform" method="POST">
                    @csrf
                    <div class="row">
                        @php
                        ...
                        <div class="col-lg-6">
                            ...
                            <x-adminlte-input name="nip_lama" label="NIP Lama"
                                placeholder="NIP Lama" enable-old-support />
                            <x-adminlte-input  name="nama_lengkap" label="Nama Pegawai"
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <x-adminlte-input name="unit_kerja" label="Unit Kerja"
                                        enable-old-support required />
                                </div>
                                <div class="col-md-4">
                                    <x-adminlte-input  name="status" label="Status Pegawai"
                                        placeholder="Status Pegawai" enable-old-support required />
                                </div>
                                <div class="col-md-4">
                                    <x-adminlte-input  name="pangkat" label="Pangkat Pegawai"
                        ...
                        <div class="col-lg-6">
                            <div class="row">
                                <div class="col-md-4">
                                    <x-adminlte-input  name="jabatan" label="Jabatan Pegawai"
                                        placeholder="Jabatan Pegawai" enable-old-support required />
                                </div>
                                <div class="col-md-8">
                                    <x-adminlte-input  name="struktural" label="Struktural Pegawai"
                            ...
                            <div class="row">
                                ...
                                @endphp
                                <div class="col-md-3">
                                    <x-adminlte-input  name="eselon" label="Eselon Pegawai"
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <x-adminlte-input  name="gol" label="Gol Pegawai"
                                ...
                                <div class="col-md-3">
                                    <x-adminlte-input  name="tahun" label="Tahun Pegawai"
                                    enable-old-support required />
                                </div>
                                <div class="col-md-3">
                                    <x-adminlte-input  name="bulan" label="Bulan Pegawai"
                                ...
                                <div class="col-md-3">
                                    <x-adminlte-select2 name="jenjang" required id="jenjang" label="jenjang">
                                        @foreach ($pendidikan as $pd)
                                            <option value="{{$pd->id_tingkat}}">{{$pd->nama_tingkat}}</option>
                                        @endforeach
                                    </x-adminlte-select2>
                                </div>
                                <div class="col-md-6">
                                    <x-adminlte-input name="jurusan" label="Jurusan Pendidikan"
                                        enable-old-support required />
                                </div>
                                <div class="col-md-3">
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <x-adminlte-input  name="format_pendidikan" label="Format Pendidikan"
                                        enable-old-support required />
                                </div>
                                <div class="col-md-3">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <x-adminlte-input  name="no_str" label="No Str"
                                        enable-old-support required />
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <x-adminlte-input  name="no_sip" label="No SIP"
                                        enable-old-support required />
                                </div>
                                <div class="col-md-4">
