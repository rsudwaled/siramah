...
@section('body')
    <div class="wrapper">
        <div class="row p-1">
            <div class="col-md-5">
                <x-adminlte-card title="Checkin Antrian Online RSUD Waled" theme="primary" icon="fas fa-qrcode">
                    <div class="text-center">
                        <x-adminlte-input name="kodebooking" label="Silahkan Scan QR Code atau masukan Kodebooking Antrian"
                ...
                <x-adminlte-card title="Informasi Antrian" theme="primary" icon="fas fa-user-injured">
                    ...
                    <x-slot name="footerSlot">
                        ...
                        <a href="{{ route('testmesinantrian') }}" class="btn btn-warning withLoad"><i
    ...
    <script>
        $(function() {
            ...
            $('#btnDaftarPoliBPJS').click(function() {
                ...
                var url = "{{ route('ambil_antrian_offline_bpjs') }}" + "?kodesubspesialis=" +
            ...
            $('#btnDaftarPoliUmum').click(function() {
                var kodesubspesialis = $("input[name=kodesubspesialis]:checked").val();
                var kodedokter = $("input[name=kodedokter]:checked").val();
                var url = "{{ route('ambil_antrian_offline_umum') }}" + "?kodesubspesialis=" +
                    kodesubspesialis + "&kodedokter=" + kodedokter;
                window.location.href = url;
            });
