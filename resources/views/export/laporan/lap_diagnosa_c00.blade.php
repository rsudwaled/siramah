    ...
    <table>
        <thead>
            <tr>
                ...
                <th>Diagnosa Komplikasi</th>
                <th>Operasi</th>
                <th>Meninggal < 48jam</th>
                <th>Meninggal > 48jam</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($pasiens as $pasien)
                ...
                <tr>
                    ...
                    <td>
                        {{ $pasien->id_ruangan == null ? 'RAJAL' : 'RANAP' }}
                    </td>
                    <td>{{ $pasien->status_kunjungan }}</td>
                    <td>{{ $pasien->kasus_baru }}</td>
                    <td>{{ $pasien->nama_unit }}</td>
                    ...
                    <td>{{ $pasien->meninggal_kr_48jam == '1' ? 'Ya' : 'Tidak' }}</td>
                    <td>{{ $pasien->meninggal_lb_48jam == '1' ? 'Ya' : 'Tidak' }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
