...
class LaporanRLEmpatSatuVersi6 implements FromView
{
    public function view(): View
    {
        ...
        // pasien keluar mati atau hidup

        // dd($dataGabungan, $data[0]);
        // Tampilkan atau kirim ke view
        return view('export.laporan.laporan_rl_4_1_versi_6', [
