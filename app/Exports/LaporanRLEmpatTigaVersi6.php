...
class LaporanRLEmpatTigaVersi6 implements FromView
{
    public function view(): View
    {
        ...
        ->sortByDesc(function ($item) {
            $meninggalL = $item['rekap_status']['Meninggal']['L'] ?? 0;
            $meninggalP = $item['rekap_status']['Meninggal']['P'] ?? 0;
            return $meninggalL + $meninggalP;
        })
        ->take(30)
        ->toArray();
        ...
        return view('export.laporan.laporan_rl_4_3_versi_6', [
