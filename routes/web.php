...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/ranap/pasien-bpjs/bridging-steps/{kunjungan}', [App\Http\Controllers\IGD\Ranap\RanapController::class, 'ranapCreateSEPRanap'])->name('create-sepigd.ranap-bpjs');
